...
function specs = build_stage_signal_specs()
    specs = { ...
        ...
        struct('name', 'q_proj_out', 'data_name', 'q_stream', 'data_block', 'qkv_proj_u/q_mul', 'data_port', 1, 'valid_name', 'q_valid', 'valid_block', 'qkv_proj_u/q_valid_alias', 'valid_port', 1), ...
        struct('name', 'k_proj_out', 'data_name', 'k_stream', 'data_block', 'qkv_proj_u/k_mul', 'data_port', 1, 'valid_name', 'kv_valid', 'valid_block', 'qkv_proj_u/kv_valid_alias', 'valid_port', 1), ...
