...
%RUN_STAGE2_WEIGHT_PATH_ASSERTIONS Structural+semantic assertions for DDR->RAM weight path.
    ...
    require_edge(mdlName, 'weight_addr_map_u/1', 'rmsnorm_u/5');
    require_edge(mdlName, 'weight_addr_map_u/2', 'qkv_proj_u/8');
    require_edge(mdlName, 'weight_addr_map_u/5', 'attention_u/8');
    require_edge(mdlName, 'weight_addr_map_u/8', 'ffn_swiglu_u/6');
    require_edge(mdlName, 'w_req_mux/1', 'axi_weight_rd_u/1');
    require_edge(mdlName, 'axi_weight_rd_u/1', 'w_rsp_demux/1');
